						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="kechengmingchengSearch" class="form-control form-control-sm" placeholder="请输入课程名称" aria-controls="tableId">
									<label>
										课程类型
									</label>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var kechengwenjianCell  = document.createElement('td');
			  ...
			  var kechengwenjianFileAttr = "download('" +baseUrl+ item.kechengwenjian + "')"
